...
const int MAX_DEFS_PER_INSTR = 100;
// The maximum number of register usages per instruction node.
const int MAX_USES_PER_INSTR = 100;
...
class SchedInstruction : public GraphNode {
  public:
    ...
    SchedInstruction(InstCount num,
                     const string& name,
                     InstType instType,
                     const string& opCode,
    ...
    void SetupForSchdulng(InstCount instCnt,
                          bool isCP_FromScsr,
   ...
   /***************************************************************************/
    ...
    bool PrdcsrSchduld(InstCount prdcsrNum,
                       InstCount cycle,
                       InstCount& rdyCycle);
    ...
    bool TightnLwrBound(DIRECTION dir,
    ...
    bool TightnLwrBoundRcrsvly(DIRECTION dir,
                               InstCount newLwrBound,
                               LinkedList<SchedInstruction>* tightndLst,
                               LinkedList<SchedInstruction>* fxdLst,
                               bool enforce);
...
class SchedRange {
  public:
    ...
    bool SetBounds(InstCount frwrdLwrBound,
