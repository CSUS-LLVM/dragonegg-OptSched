...
class GraphNode {
  ...
  protected:
    ...
    bool FindScsr_(GraphNode*& crntScsr,
                   UDT_GNODES trgtNum,
                   UDT_GLABEL trgtLbl);
...
class DirAcycGraph {
  ...
  protected:
    ...
    // given label.
    void CreateEdge_(UDT_GNODES frmNodeNum,
...
inline void GraphNode::RmvLastScsr(GraphNode* scsr, bool delEdg) {
  ...
  if (delEdg) delete scsrLst_->GetLastElmnt();
...
inline void GraphNode::RmvLastPrdcsr(GraphNode* prdcsr, bool delEdg) {
  ...
  if (delEdg) delete prdcsrLst_->GetLastElmnt();
  prdcsrLst_->RmvLastElmnt();
}

inline void GraphNode::SetColor(GNODE_COLOR color) {
  color_ = color;
}
...
inline GNODE_COLOR GraphNode::GetColor() const {
  return color_;
}

inline UDT_GNODES GraphNode::GetNum() const {
  return num_;
}

inline void GraphNode::SetNum(UDT_GNODES num) {
  num_ = num;
}
...
inline UDT_GLABEL GraphNode::GetScsrLblSum() const {
  return scsrLblSum_;
}

inline UDT_GLABEL GraphNode::GetPrdcsrLblSum() const {
  return prdcsrLblSum_;
}

inline UDT_GNODES GraphNode::GetTplgclOrdr() const {
  return tplgclOrdr_;
}

inline UDT_GLABEL GraphNode::GetMaxEdgeLabel() const {
  return maxEdgLbl_;
}
