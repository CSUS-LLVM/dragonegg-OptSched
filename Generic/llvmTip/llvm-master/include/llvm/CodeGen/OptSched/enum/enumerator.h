...
class EnumTreeNode {
  private:
    ...
    class ExaminedInst {
      ...
      public:
        ...
        inline bool wasRlxInfsbl() {
          return wasRlxInfsbl_;
        }
  ...
  public:
    ...
    void NewBranchExmnd(SchedInstruction* inst, bool isLegal,
                        bool isNodeDmntd, bool isRlxInfsbl,
                        bool isFsbl, DIRECTION dir, bool isLngthFsbl);
    ...
    bool GetCrntCycleBlkd() {
      return crntCycleBlkd_;
    }
    void SetCrntCycleBlkd(bool blkd) {
      crntCycleBlkd_ = blkd;
    }
    int GetRealSlotNum() {
      return realSlotNum_;
...
class EnumTreeNodeAlloc: public MemAlloc<EnumTreeNode> {
  public:
    ...
    inline EnumTreeNode* Alloc(EnumTreeNode* prevNode,
                               SchedInstruction* inst,
                               Enumerator* enumrtr);
...
class Enumerator : public ConstrainedScheduler {
  ...
  protected:
    ...
    FUNC_RESULT FindFeasibleSchedule_(InstSchedule* sched,
                                      InstCount trgtLngth,
...
class LengthEnumerator: public Enumerator {
  ...
  public:
    ...
    FUNC_RESULT FindFeasibleSchedule(InstSchedule* sched,
                                     InstCount trgtLngth,
                                     Milliseconds deadline);
    bool IsCostEnum();
...
InstCount EnumTreeNode::GetBranchCnt() {
  return brnchCnt_;
}
/**************************************************************************/
...
InstCount EnumTreeNode::GetCrntBranchNum() {
  return crntBrnchNum_;
}
/**************************************************************************/

SchedInstruction* EnumTreeNode::GetInst() {
  return inst_;
}
/**************************************************************************/
...
inline EnumTreeNode* EnumTreeNode::GetParent() {
  return prevNode_;
}
/**************************************************************************/
...
inline bool EnumTreeNode::IsRoot() {
  return prevNode_ == NULL;
}
/**************************************************************************/

inline uint64_t EnumTreeNode::GetNum() {
  return num_;
}
/**************************************************************************/

inline void EnumTreeNode::SetNum(uint64_t num) {
  num_ = num;
}
/**************************************************************************/

inline InstSignature EnumTreeNode::GetSig() {
  return prtilSchedSig_;
}
/**************************************************************************/

inline InstCount EnumTreeNode::GetTime() {
  return time_;
}
/**************************************************************************/
...
inline HistEnumTreeNode* EnumTreeNode::GetDmntdSubProb() {
  return dmntdNode_;
}
/**************************************************************************/
...
inline ReadyList* EnumTreeNode::GetRdyLst() {
  return rdyLst_;
}
/**************************************************************************/

inline ENUMTREE_NODEMODE EnumTreeNode::GetMode() {
  return mode_;
}
/**************************************************************************/

inline InstCount EnumTreeNode::GetLegalInstCnt() {
  return legalInstCnt_;
}
/**************************************************************************/

inline SchedInstruction* EnumTreeNode::ExaminedInst::GetInst() {
  return inst_;
}
/**************************************************************************/
...
inline HistEnumTreeNode* EnumTreeNode::GetHistory() {
  return hstry_;
}
/**************************************************************************/
...
inline bool EnumTreeNode::IsArchived() {
  return isArchivd_;
}
/**************************************************************************/
...
inline void EnumTreeNode::SetFsblty(bool isFsbl) {
  isFsbl_ = isFsbl;
}
/**************************************************************************/

inline void EnumTreeNode::SetLngthFsblty(bool value) {
  isLngthFsbl_ = value;
}
/**************************************************************************/

inline bool EnumTreeNode::IsLeaf() {
  return isLeaf_;
}
...
InstCount EnumTreeNode::GetCost() {
  return cost_;
}
/*****************************************************************************/
...
InstCount EnumTreeNode::GetCostLwrBound() {
  return costLwrBound_;
}
/*****************************************************************************/
...
InstCount EnumTreeNode::GetPeakSpillCost() {
...
InstCount EnumTreeNode::GetSpillCostSum() {
  return spillCostSum_;
}
/*****************************************************************************/
...
bool EnumTreeNode::ExaminedInst::IsRsrcDmntd(SchedInstruction*) {
  if (!wasRlxInfsbl_) return false;

  for (TightndInst* tightndScsr = tightndScsrs_->GetFrstElmnt();
       tightndScsr != NULL;
       tightndScsr = tightndScsrs_->GetNxtElmnt()) {
...
inline InstCount Enumerator::GetCrntCycleNum_() {
  return crntCycleNum_;
}
/*****************************************************************************/

inline int Enumerator::GetCrntSlotNum_() {
  return crntSlotNum_;
}
/*****************************************************************************/
...
inline uint64_t Enumerator::GetNodeCnt() {
  return exmndNodeCnt_;
}
/****************************************************************************/

inline int Enumerator::GetSearchCnt() {
  return iterNum_;
}
/****************************************************************************/
...
inline bool Enumerator::ChkCrntNodeForFsblty_() {
  ...
  for (inst = bkwrdTightndLst_->GetFrstElmnt();
       inst != NULL;
...
bool Enumerator::IsHistDom() {
  return prune_.histDom;
}
/******************************************************************************/

bool Enumerator::IsRlxdPrnng() {
  return prune_.rlxd;
}
/******************************************************************************/
